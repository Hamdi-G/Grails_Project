...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def poi_1 = new Poi(name: 'poiName1', description: 'poiDesc1', lat: 43.729497, lng:7.146764 ,groupe: group_1).save()
        ...
        def poi_2 = new Poi(name: 'poiName2', description: 'poiDesc2', lat: 43.689283, lng:7.241745, groupe: group_2).save()
        poi_2.addToImages(image_P2).save()
        def poiG_2 = new PoiGroup(poi: poi_2, groupe: group_2).save(flush:true)

        def poi_3 = new Poi(name: 'poiName3', description: 'poiDesc3', lat: 2.2, lng:3.2, groupe: group_2).save()
        ...
        def poi_4 = new Poi(name: 'poiName4', description: 'poiDesc4', lat: 2.3, lng:3.3, groupe: group_3).save()
        poi_4.addToImages(image_P4).save()
        def poiG_4 = new PoiGroup(poi: poi_4,groupe: group_3).save()


        def poi_5 = new Poi(name: 'poiName5', description: 'poiDesc5', lat: 2.4, lng:3.4, groupe: group_3).save()
